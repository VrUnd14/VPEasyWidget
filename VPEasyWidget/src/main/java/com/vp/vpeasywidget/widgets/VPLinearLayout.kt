...
class VPLinearLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {
    ...
    init {
        ...
        try {
            isCapsule = parent.getBoolean(R.styleable.VPLinearLayout_ll_isCapsule, isCapsule)
            capsuleRadius = parent.getDimensionPixelSize(R.styleable.VPLinearLayout_ll_capsuleRadius, 200).toFloat()
            cornerRadiusTopLeft = parent.getDimensionPixelSize(R.styleable.VPLinearLayout_ll_cornerRadiusTopLeft, 0).toFloat()
            cornerRadiusTopRight = parent.getDimensionPixelSize(R.styleable.VPLinearLayout_ll_cornerRadiusTopRight, 0).toFloat()
            cornerRadiusBottomLeft = parent.getDimensionPixelSize(R.styleable.VPLinearLayout_ll_cornerRadiusBottomLeft, 0).toFloat()
            cornerRadiusBottomRight = parent.getDimensionPixelSize(R.styleable.VPLinearLayout_ll_cornerRadiusBottomRight, 0).toFloat()
